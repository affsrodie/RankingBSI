 ...
 */
public class RegistrarAtendenteController implements Initializable {

    @FXML
    private StackPane rootRegistrar;
    ...
    public RegistrarAtendenteController(){
        
    }
    
    public RegistrarAtendenteController(LoginController Control){
        this.Pai = Control;
    }
    ...
    public void CadastrarAtendente(ActionEvent event){
     ...
     if(ValidarCampos()==true&&ValidarSenha()==true){
        ...
        try{
        atendente.setID(atenRep.gerarID());
        this.atendente=atendente;
        atenRep.adicionar(atendente);
    ...
    public void returnLogin(){
        if(atendente!=null){
            Pai.returnLogin(this.atendente);
        }
    }
    
    @FXML
    public void cancelarRegistro(){
            Pai.cancelarRegistro();
    }

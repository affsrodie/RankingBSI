 ...
 */
public class AdicionarEntradaController implements Initializable {
    ...
    @FXML
    private JFXTextField tfdNomeEntrada;
    ...
    public AdicionarEntradaController (){
        
    }
    
    public AdicionarEntradaController (MainCaixaController pai){
        Pai=pai;
    }
    ...
    public void SalvarConta(MouseEvent event){
        ...
        if(validarCampos.checkEmptyFields(tfdNomeEntrada,tfdCPF, tfdValor,tfdEndereco, tfdReferencia)){
            conta.setNome(tfdNomeEntrada.getText());
